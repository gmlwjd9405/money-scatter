...
public class UserAndRoomInfo {
    ...
    private UserAndRoomInfo(final Long ownerId, final String roomId) {
        this.ownerId = ownerId;
        this.roomId = roomId;
    }

    public static UserAndRoomInfo of(final Map<String, Object> headers) {
        ...
        return new UserAndRoomInfo(ownerId, roomId);
    }
